...
function addQuestions(question) {
  ...
  questionArray.push(questionAsked);
  //questionDiv
...
submitButton.addEventListener("click", function (e) {
  ...
  $.post('/data', {data : newArray});
  // $.ajax({
  //   url: '/data',
  //   method: 'POST',
  //   contentType: 'application/json',
  //   accept: 'application/json',
  //   data:  JSON.stringify({ myData: 'This is my data.' }),
  //   success: function (res) {
  //     console.log("data sent successfully")
  //     //res.send(mobileNumber);
  //     // createBotBubble(res.output);
  //   },
  //   error: function (err) {
  //     // if (language === 'hi') {
  //     //   createBotBubble('माफ़ कीजिये! मुझे कुछ त्रुटि हुई।');
  //     // } else {
  //     //   createBotBubble('Sorry! I encountered some error.');
  //     // }
  //   },
  //   complete: function () {
  //     // bubble.remove();
